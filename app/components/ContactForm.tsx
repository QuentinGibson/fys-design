    ...
    <div className="max-w-lg mx-auto">
      <div className="bg-secondary text-primary">
        <div className="flex flex-col items-center py-6">
          <h3 className="text-4xl w-3/4 text-center mb-8">Ready to get started?</h3>
        ...
        <div className="py-6 mx-4 grid grid-flow-row gap-6">
          ...
          <div className="flex flex-col">
            <label className="font-bold mb-2" htmlFor="service">Service you are insterested in</label>
          ...
          <div className="flex flex-col">
            <label className="font-bold mb-2" htmlFor="email">Email Address</label>
